...
.category-card { background: #1e293b; border: 1px solid #1e293b; border-radius: 12px; padding: 20px 24px; display: flex; justify-content: space-between; align-items: center; transition: border-color 0.2s; }
.category-card:hover { border-color: #334155; }
.category-info h3 { color: #f1f5f9; font-size: 16px; font-weight: 600; margin: 0 0 4px; }
.category-info p { color: #64748b; font-size: 13px; margin: 0; }
.activity-action { display: flex; gap: 8px; align-items: center; }
.amount-input { width: 100px; background: #0f172a; border: 1px solid #334155; border-radius: 8px; padding: 8px 12px; color: #f1f5f9; outline: none; font-size: 14px; transition: border-color 0.2s; }
.amount-input:focus { border-color: #38bdf8; }
.add-btn { padding: 8px 14px; background: #2563eb; color: white; border: none; border-radius: 8px; font-size: 16px; font-weight: 700; cursor: pointer; transition: all 0.2s; }
